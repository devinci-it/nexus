...
namespace Classes\UI\Input;

class SvgInputGenerator {
    private $attributes;
    ...
    public function generate($placeholder, $svgFilename, $size = null, $isLabeled = false, $typeName = 'text', $isError = false, $stickyValue = null) {
        if (!$stickyValue) {
            $stickyValue = '';
        }
